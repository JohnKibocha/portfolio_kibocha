"""
Django's settings for portfolio_kibocha project.
...
INSTALLED_APPS = [
    ...
    'portfolio_kibocha_app.apps.PortfolioKibochaAppConfig',
...
ROOT_URLCONF = 'portfolio_kibocha.urls'
...
WSGI_APPLICATION = 'portfolio_kibocha.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'portfolio_database.sqlite3',
    }
}
